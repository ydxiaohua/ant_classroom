    ...
    <div id="aCoursesList" class="bg-fa of">
        ...
        <section class="container">
            <section class="path-wrap txtOf hLh30">
                ...
                \ <span class="c-333 fsize14">${dginfo.coursename}</span>
            </section>
            <div>
                <article>
                    <section>
                ...
                <aside class="c-attr-wrap">
                    <section class="ml20 mr15">
                        <h2 class="hLh30 txtOf mt15">
                            <span class="c-fff fsize24">${dginfo.coursename}</span>
                        </h2>
                        <section class="c-attr-jg">
                            <span class="c-fff">价格：</span><big class="c-yellow">￥${dginfo.xianprice}</big>
                            <span class="c-ccc ml10">原价：<s>￥${dginfo.yuanprice}</s></span>
                        </section>
                        <section class="c-attr-mt c-attr-undis">
							<span class="c-fff fsize14">主讲：${dginfo.teachername}&nbsp;&nbsp;&nbsp;
                            </span>
                        </section>
                    ...
                    <ol class="thr-attr-ol clearfix">
                        <li><p>&nbsp;</p>
                            <aside>
                                ...
                                <h6 class="c-fff f-fM mt10">${dginfo.downcode}</h6>
                            </aside>
                        </li>
                        <li><p>&nbsp;</p>
                            <aside>
                                <span class="c-fff f-fM">课时数</span><br>
                                <h6 class="c-fff f-fM mt10">${dginfo.coursecode}</h6>
                            </aside>
                        </li>
                        <li><p>&nbsp;</p>
                            <aside>
                                <span class="c-fff f-fM">浏览数</span><br>
                                <h6 class="c-fff f-fM mt10">${dginfo.lookcode}</h6>
                            </aside>
                        </li>
                    </ol>
                </aside>
...
<script>
    function addComment(){
        ...
        $.ajax({
            ...
            type:"post",
            data:{'comcontent':comcontent,'courseid':${dginfo.courseid}},
            dataType : 'json',
            success :function (data){
                if(data==1){
                    alert("评论成功");
    ...
    $.ajax({
        url :"../index/queryDagang?courseid="+${dginfo.courseid},
        type : 'post',
        dataType : 'json',
        success : function(data) {
            ...
            for (var i =0; i< data.length; i++) {
                ...
                if(data[i].xiaojie==${dginfo.xiaojie}){
    ...
    function jumpPage(flag){
        ...
        $.ajax({
            ...
            type:"get",
            data:{"page":page, "rows":pageSize,"courseid":${dginfo.courseid}},
            dataType:"json",
            async:false,
            success : function (data) {
                var pingul="";
    ...
    function dagangInfo(dgid){
        ...
        location.href="../index/queryDGinfo?dgid="+dgid+"&courseid="+${dginfo.courseid};

    }
</script>
<!-- 统计代码 -->
<input type="text" id="aaas">
</body>
</html>
