	...
	$.ajax({
		...
		success : function(result) {
			if (result.success == false) {
				...
				} else if (type == 2 && loginRest != '') {
					window.location.href = loginRest;
				} else {
