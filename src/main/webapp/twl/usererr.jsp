...
<table class="table" id="usererr" border="1"></table>
...
<script type="text/javascript">
    ...
    //查询
    $("#usererr").bootstrapTable({
        url:"<%=request.getContextPath()%>/comm/queryusererr",
        striped: true,//隔行变色
        ...
        columns:[
            {field:'errorvalue',title:'错误方法具体路径',width: 100},
        ]
    })
